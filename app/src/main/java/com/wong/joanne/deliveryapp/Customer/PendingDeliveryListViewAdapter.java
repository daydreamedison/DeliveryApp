...
public class PendingDeliveryListViewAdapter  extends ArrayAdapter<DeliveryFirebaseModel> {

    private final Context context;
    private List<DeliveryFirebaseModel> historiesList;
    private LayoutInflater inflater;

    public PendingDeliveryListViewAdapter(Context context, List<DeliveryFirebaseModel> historiesList){
